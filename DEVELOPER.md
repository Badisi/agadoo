...
1. Make any modification to the source code
...
2. Push the changes
3. Create a new [GitHub release](https://github.com/Badisi/agadoo/releases/new)
4. Watch the results in: [Actions](https://github.com/Badisi/agadoo/actions)
